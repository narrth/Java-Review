...
public class SeatTest extends junit.framework.TestCase
{
	 ...
	 * is still booked. Check that the seat number and the price for 
	 * each seat are not the same.
	 */
	 ...
	 * 
	 * Try to cancel a booking that hasn't been made.  Book a seat
	 * and cancel the booking, and check that it isn't booked.  Try
	 * cancelling the booking again and check that cancelBooking()
	 * returns false and that the seat is still not booked. Check that
	 * the seat number and the price for each seat are not the same.
	 */
