...
public class TimingEngine
{
     ...
     * The result is a string in the format "m:ss:hh".
     * @ return:  totalTime(m:ss:hh format)
     */
     ...
     * only set legnth if it is greater than 0
     * @param: length
     */
     ...
     * format "m:ss:hh".
     * @param: time
     * @return: minutes:seconds:hundreths(time in m:ss:hh format)
     */
     ...
     * @param: number
     * @return: number (to a fixed 2 placevalues)
     */
