...
public class Money implements Comparable
{
    ...
    public Money addMonies (int number, int cents, Object obj)
    {
        ...
        {
        throw new IllegalArgumentException("The number isn't within the correct range.");
        }
        
        if(cents>99 || cents <0)
        {
        throw new IllegalArgumentException("The cents aren't within the correct range.");
        }
        ...
        if(!(obj instanceof Money))
        {
        throw new ClassCastException("The object is not a money object");
        }
